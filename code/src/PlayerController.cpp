...
void PlayerController::SetPosition(float x, float y, float z)
{
	m_positionX = x;
	m_positionY = y;
	m_positionZ = z;
...
void PlayerController::SetRotation(float x, float y, float z)
{
	m_rotationX = x;
	m_rotationY = y;
	m_rotationZ = z;
...
void PlayerController::GetPosition(float& x, float& y, float& z)
{
	x = m_positionX;
	y = m_positionY;
	z = m_positionZ;
...
void PlayerController::GetRotation(float& x, float& y, float& z)
{
	x = m_rotationX;
	y = m_rotationY;
	z = m_rotationZ;
...
void PlayerController::SetFrameTime(float time)
{
	m_frameTime = time;
	return;
}
...
void PlayerController::MoveForward(bool keydown)
{
	float radians;
...
void PlayerController::MoveBackward(bool keydown)
{
	float radians;
...
void PlayerController::MoveUpward(bool keydown)
{
...
void PlayerController::MoveDownward(bool keydown)
{
...
void PlayerController::TurnLeft(bool keydown)
{
...
void PlayerController::TurnRight(bool keydown)
{
...
void PlayerController::LookUpward(bool keydown)
{
...
void PlayerController::LookDownward(bool keydown)
{
